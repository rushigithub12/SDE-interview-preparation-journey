...
source: "https://bytebytego.com/courses/system-design-interview/distributed-message-queue"
author:
  - "[[ByteByteGo]]"
published:
created: 2026-03-31
...
2. The routing layer reads the replica distribution plan [^1] from the metadata storage and caches it locally. When a message arrives, it routes the message to the leader replica of partition 1, which is stored in broker 1.
